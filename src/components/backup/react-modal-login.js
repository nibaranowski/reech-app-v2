...
import FacebookLoginButton from "./LoginFormComponents/FacebookLoginButton";
import GoogleLoginButton from "./LoginFormComponents/GoogleLoginButton";
import Tabs from "./LoginFormComponents/Tabs";
import CloseBtn from "./LoginFormComponents/Close";

import SubmitError from "./LoginFormComponents/SubmitError";

import Separator from "./LoginFormComponents/Separator";
import Loader from "./LoginFormComponents/Loader";

import FormWrap from "./LoginFormComponents/FormWrap";

//require('../../styles/login-form/style.less');
